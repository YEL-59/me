...
export default function SiteFooter() {
  ...
  const footerLinks = data?.siteSettings?.footerLinks?.length
  ...
  const values = data?.siteSettings?.brandValues?.length
    ? data.siteSettings.brandValues
    : ["Clarity", "Utility", "Empathy", "Craft"];
  const copyright =
    data?.siteSettings?.copyrightText ?? "© 2026 Tofayel. All rights reserved.";
