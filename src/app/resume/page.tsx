...
export default function ResumePage() {
  return (
    <PageShell
      title="Resume"
      subtitle="Download my PDF resume or view the ATS-friendly version optimized for recruiters and applicant systems."
      accent="#ef4444"
    >
      <div className="grid gap-4 sm:grid-cols-2">
        <a
          href="/resume/tofayel-resume.pdf"
          download
        ...
        >
          ...
          <p className="mt-2 text-xs leading-relaxed" style={{ color: "var(--text-secondary)" }}>
            Visual PDF with layout, colors, and portfolio styling. Best for direct sharing.
          </p>
        ...
        >
          ...
          <p className="mt-2 text-xs leading-relaxed" style={{ color: "var(--text-secondary)" }}>
            Plain, parseable format for job portals and recruiter systems. Built from LaTeX source.
          </p>
      ...
      >
        ...
        <p className="mt-2 text-xs leading-relaxed" style={{ color: "var(--text-secondary)" }}>
          ...
          <a
            href="https://github.com/YEL-59/Resumelatex"
            target="_blank"
            rel="noopener noreferrer"
            className="text-violet-400 hover:underline"
          >
            github.com/YEL-59/Resumelatex
          </a>
          {" "}or download{" "}
          <a
